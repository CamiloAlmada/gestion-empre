...
describe('itemsSelectorStock', () => {
  ...
  it('admin: suma Proveedores y Precios, en ese orden', () => {
    const items = itemsSelectorStock(true);
    expect(items.map((i) => i.etiqueta)).toEqual(['Stock', 'Catálogo', 'Proveedores', 'Precios']);
  });
});
...
describe('SelectorSeccion', () => {
  ...
  it('vendedor: no ve los ítems "Proveedores" ni "Precios"', () => {
